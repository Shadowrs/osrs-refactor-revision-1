public class ItemDef extends Class104_Sub18 {
	...
	void method773(final RSBuf var1, final int var2) {
		if (var2 == 1)
			anInt1419 = var1.readShort();
		else if (var2 == 2)
			aString1444 = var1.readString();
		else if (var2 == 4)
			anInt1425 = var1.readShort();
		else if (var2 == 5)
			anInt1426 = var1.readShort();
		else if (var2 == 6)
			anInt1427 = var1.readShort();
		else if (var2 == 7) {
			anInt1454 = var1.readShort();
			if (anInt1454 > 32767)
				anInt1454 -= 65536;
		} else if (var2 == 8) {
			anInt1430 = var1.readShort();
			if (anInt1430 > 32767)
				anInt1430 -= 65536;
		} else if (var2 == 11)
			anInt1431 = 1;
			...
			anInt1436 = var1.readShort();
			anInt1438 = var1.readUByte();
		} else if (var2 == 24)
			anInt1437 = var1.readShort();
		else if (var2 == 25) {
			anInt1457 = var1.readShort();
			anInt1441 = var1.readUByte();
		} else if (var2 == 26)
			anInt1443 = var1.readShort();
		else if ((var2 >= 30) && (var2 < 35)) {
			aStringArray1434[var2 - 30] = var1.readString();
			if (aStringArray1434[var2 - 30].equalsIgnoreCase("Hidden"))
				aStringArray1434[var2 - 30] = null;
		} else if ((var2 >= 35) && (var2 < 40))
			aStringArray1435[var2 - 35] = var1.readString();
		else {
			int var3;
			int var4;
			if (var2 == 40) {
				...
				for (var4 = 0; var4 < var3; ++var4) {
					aShortArray1421[var4] = (short) var1.readShort();
					aShortArray1422[var4] = (short) var1.readShort();
				}
			} else if (var2 == 41) {
				var3 = var1.readUByte();
				...
				for (var4 = 0; var4 < var3; ++var4) {
					aShortArray1423[var4] = (short) var1.readShort();
					aShortArray1424[var4] = (short) var1.readShort();
				}
			} else if (var2 == 78)
				anInt1445 = var1.readShort();
			else if (var2 == 79)
				anInt1448 = var1.readShort();
			else if (var2 == 90)
				anInt1414 = var1.readShort();
			else if (var2 == 91)
				anInt1429 = var1.readShort();
			else if (var2 == 92)
				...
				anInt1442 = var1.readShort();
			else if (var2 == 98)
				anInt1433 = var1.readShort();
				...
				anIntArray1450[var2 - 100] = var1.readShort();
				anIntArray1449[var2 - 100] = var1.readShort();
			} else if (var2 == 110)
				anInt1452 = var1.readShort();
			else if (var2 == 111)
				anInt1428 = var1.readShort();
			else if (var2 == 112)
				anInt1439 = var1.readShort();
			else if (var2 == 113)

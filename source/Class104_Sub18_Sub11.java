public class Class104_Sub18_Sub11 extends Class104_Sub18 {
	...
	void method767(final Class104_Sub21 var1) {
		while (true) {
	...
	void method768(final Class104_Sub21 var1, final int var2) {
		if (var2 == 5)
			anInt1412 = var1.method571();
	...
	static final void method770(final int var0, final int var1, final int var2, final int var3, final int var4,
		...
		if (Class104_Sub7.method508(var0)) {
			...
			Class66.method300(Class22.aClass104_Sub12ArrayArray228[var0], -1, var1, var2, var3, var4, var5, var6, var7);
			...
			client.aBoolArray2027[var7] = true;
		else
			for (int var8 = 0; var8 < 100; ++var8)
				client.aBoolArray2027[var8] = true;
	}
}

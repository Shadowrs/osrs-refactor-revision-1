public class Class104_Sub18_Sub5 extends Class104_Sub18 {
	...
	void method731(final RSBuf var1, final int var2) {
		if (var2 == 1)
			anInt1309 = var1.readShort();
		else if (var2 == 2)
			anInt1316 = var1.readShort();
		else if (var2 == 4)
			anInt1304 = var1.readShort();
		else if (var2 == 5)
			anInt1315 = var1.readShort();
		else if (var2 == 6)
			anInt1306 = var1.readShort();
		else if (var2 == 7)
			...
			if (var2 == 40) {
				...
				for (var4 = 0; var4 < var3; ++var4) {
					aShortArray1310[var4] = (short) var1.readShort();
					aShortArray1312[var4] = (short) var1.readShort();
				}
			} else if (var2 == 41) {
				var3 = var1.readUByte();
				...
				for (var4 = 0; var4 < var3; ++var4) {
					aShortArray1313[var4] = (short) var1.readShort();
					aShortArray1314[var4] = (short) var1.readShort();
				}
			}
		}
